...
root1="./data/coastline/gnomonic_standard_points/asia-cil-GNOM.txt"
root2="./data/coastline/gnomonic_standard_points/europe-cil-GNOM.txt"
root3="./data/coastline/gnomonic_standard_points/africa-cil-GNOM.txt"
root4="./data/coastline/gnomonic_standard_points/namer-cil-GNOM.txt"
root5="./data/coastline/gnomonic_standard_points/samer-cil-GNOM.txt"
root6_meridians="./data/parallel_meridians/gnomonic_standard/meridians_GNOM.txt"
root7_parallels="./data/parallel_meridians/gnomonic_standard/parallels_GNOM.txt"
