...
save_folder="stereographic_2"
suffix="STER" 
name="Stereographic_2"
...
# PARAMETERS
angle=30
center=np.array([40,-4])

# PROJECTION
point_calc=partial(stereographic_map,phi_max=angle,center=center)
